...
import { J as onBeforeUnmount, K as client, L as listenOpts, M as stopAndPrevent, O as getEventPath, P as createComponent, C as ref, B as computed, Q as watch, R as h$1, T as Transition, S as hSlot, U as getCurrentInstance, V as nextTick, W as childHasFocus, X as useAlignProps, Y as useAlign, Z as inject, _ as formKey, $ as useSizeProps, a0 as useSize, a1 as hMergeSlotSafely, a2 as debounce, a3 as injectProp, a4 as onBeforeUpdate, a5 as onDeactivated, a6 as onActivated, a7 as onMounted, a8 as isRuntimeSsrPreHydration, a9 as prevent, aa as QIcon, ab as QSpinner, ac as shouldIgnoreKey, ad as stop, ae as hMergeSlot, af as isPlainObject, ag as toRaw, ah as QBtn, ai as isKeyCode, aj as createGlobalNode, ak as createChildApp, al as removeGlobalNode, a as defineComponent, u as useRouter, r as resolveComponent, o as openBlock, b as createElementBlock, H as createBlock, q as unref, am as mdiCircleEditOutline, G as createCommentVNode, e as createVNode, an as mdiTrashCan, ao as mdiPlusBox, t as createTextVNode, x as toDisplayString, l as dayjs, p as createBaseVNode } from "./vendor.3acfd760.js";
import { c as client$1, m as mountComponent } from "./index.50f3833d.js";
import { C as CircleSpinner } from "./circle-spinner.fbe2cb0c.js";
import { g as getHorizontalScrollPosition, a as getVerticalScrollPosition, h as hasScrollbar, u as useModelToggleProps, b as useTransitionProps, c as useModelToggleEmits, d as useTimeout, e as useTick, f as usePortal, i as useModelToggle, j as addFocusFn, r as removeFocusout, k as removeEscapeKey, l as addFocusout, m as addEscapeKey, n as useDarkProps, o as useDark, p as removeFocusFn, q as useFormProps, s as useFormInputNameAttr, t as optionSizes, v as useRefocusTarget, w as useFormInject, x as useCheckboxProps, y as useCheckboxEmits, z as useCheckbox, Q as QCheckbox, A as useTimeblockStore, B as timeblockDateToDayjs, C as dayjsToTimeblockDate } from "./date.1e92fd02.js";
...
var QDialog = createComponent({
  ...
  setup(props, { slots, emit, attrs }) {
    ...
    function renderPortalContent() {
      return h$1("div", __spreadProps(__spreadValues({}, attrs), {
        ...
        h$1(Transition, { name: transition.value, appear: true }, () => showing.value === true ? h$1("div", __spreadValues({
          ref: innerRef,
          class: classes.value,
          style: transitionStyle.value,
          tabindex: -1
...
createComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      const svgChild = [];
      props.centerColor !== void 0 && props.centerColor !== "transparent" && svgChild.push(h$1("circle", {
      ...
      props.showValue === true && child.push(h$1("div", {
        class: "q-circular-progress__text absolute-full row flex-center content-center",
        style: { fontSize: props.fontSize }
      }, slots.default !== void 0 ? slots.default() : [h$1("div", normalized.value)]));
      return h$1("div", {
...
function useValidate(focused, innerLoading) {
  ...
  function validate(val = props.modelValue) {
    ...
    const update = (err, msg) => {
      ...
      const m2 = msg || void 0;
      if (innerErrorMessage.value !== m2) {
        innerErrorMessage.value = m2;
      }
      innerLoading.value = false;
    };
    const promises = [];
...
function useField(state) {
  ...
  function getContent() {
    const node = [];
    slots.prepend !== void 0 && node.push(h$1("div", {
    ...
    slots.append !== void 0 && node.push(h$1("div", {
    ...
    if (props.loading === true || state.innerLoading.value === true) {
      node.push(getInnerAppendNode("inner-loading-append", slots.loading !== void 0 ? slots.loading() : [h$1(QSpinner, { color: props.color })]));
  ...
  function getControlContainer() {
    const node = [];
    props.prefix !== void 0 && props.prefix !== null && node.push(h$1("div", {
    ...
    if (state.getControl !== void 0) {
      ...
      node.push(h$1("div", __spreadProps(__spreadValues({
        ref: state.targetRef,
    ...
    hasLabel.value === true && node.push(h$1("div", {
      class: labelClass.value
    }, hSlot(slots.label, props.label)));
    props.suffix !== void 0 && props.suffix !== null && node.push(h$1("div", {
  ...
  function getBottom() {
    ...
    return h$1("div", {
      ...
      props.hideBottomSpace === true ? main2 : h$1(Transition, { name: "q-transition--field-message" }, () => main2),
  ...
  function getInnerAppendNode(key, content) {
    return content === null ? null : h$1("div", {
      key,
  ...
  return function renderField() {
    return h$1("label", __spreadValues({
      ref: state.rootRef,
      class: [
        classes.value,
        attrs.class
...
function useMask(props, emit, emitValue, inputRef) {
  ...
  function getPaddedMaskMarked(size) {
    ...
    if (padPos > -1) {
      for (let i2 = size - localMaskMarked.length; i2 > 0; i2--) {
        pad += MARKER;
      }
  ...
  function updateMaskInternals() {
    ...
    computedUnmask = (val) => {
      ...
      for (let i2 = 0, str = val; i2 < extractMatcherLength; i2++) {
        const m2 = extractMatcher[i2].exec(str);
        if (m2 === null) {
          break;
        }
  ...
  function onMaskedKeydown(e2) {
    ...
    if (e2.keyCode === 37 || e2.keyCode === 39) {
      const fn = moveCursor[(e2.keyCode === 39 ? "right" : "left") + (props.reverseFillMask === true ? "Reverse" : "")];
      e2.preventDefault();
      fn(inp, start, end, e2.shiftKey);
    } else if (e2.keyCode === 8 && props.reverseFillMask !== true && start === end) {
      moveCursor.left(inp, start, end, true);
    } else if (e2.keyCode === 46 && props.reverseFillMask === true && start === end) {
...
var QInput = createComponent({
  ...
  setup(props, { emit, attrs }) {
    ...
    Object.assign(state, {
      ...
      getControl: () => {
        return h$1(isTextarea.value === true ? "textarea" : "input", __spreadValues(__spreadValues(__spreadValues({
          ref: inputRef,
          class: [
  ...
  setup(props, { slots, emit }) {
    ...
    function onClick(e2) {
      ...
      if (props.disable !== true && isTrue.value !== true) {
        emit("update:modelValue", props.val, e2);
      }
    }
    ...
    return () => {
      ...
      label !== void 0 && child.push(h$1("div", {
...
var QOptionGroup = createComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    return () => h$1("div", __spreadValues({
      class: classes.value
    }, attrs.value), props.options.map((opt, i2) => {
...
var DialogPlugin = createComponent({
  ...
  setup(props, { emit }) {
    ...
    const spinner = computed(() => props.progress === false ? null : isPlainObject(props.progress) === true ? {
    ...
    const formProps = computed(() => {
      ...
      const _a = props.prompt !== void 0 ? props.prompt : props.options, { model: model2, isValid, items } = _a, formProps2 = __objRest(_a, ["model", "isValid", "items"]);
      return formProps2;
    });
    const okLabel = computed(() => isPlainObject(props.ok) === true ? $q.lang.label.ok : props.ok === true ? $q.lang.label.ok : props.ok);
    const cancelLabel = computed(() => isPlainObject(props.cancel) === true ? $q.lang.label.cancel : props.cancel === true ? $q.lang.label.cancel : props.cancel);
    ...
    function getSection(classes2, text) {
      return props.html === true ? h$1(QCardSection, {
        class: classes2,
        innerHTML: text
    ...
    function getPrompt() {
      return [
        h$1(QInput, __spreadProps(__spreadValues({
    ...
    function getOptions() {
      return [
        h$1(QOptionGroup, __spreadProps(__spreadValues({
          modelValue: model.value
        }, formProps.value), {
          color: vmColor.value,
    ...
    function getButtons() {
      const child = [];
      props.cancel && child.push(h$1(QBtn, cancelProps.value));
      props.ok && child.push(h$1(QBtn, okProps.value));
    ...
    function getCardContent() {
      ...
      props.progress !== false && child.push(h$1(QCardSection, { class: "q-dialog__progress" }, () => h$1(spinner.value.component, spinner.value.props)));
      props.message && child.push(getSection("q-dialog__message", props.message));
      if (props.prompt !== void 0) {
        child.push(h$1(QCardSection, { class: "scroll q-dialog-plugin__form" }, getPrompt));
      } else if (props.options !== void 0) {
        child.push(h$1(QSeparator, { dark: isDark.value }), h$1(QCardSection, { class: "scroll q-dialog-plugin__form" }, getOptions), h$1(QSeparator, { dark: isDark.value }));
      }
...
function merge(target, source) {
  for (const key in source) {
    if (key !== "spinner" && Object(source[key]) === source[key]) {
      target[key] = Object(target[key]) !== target[key] ? {} : __spreadValues({}, target[key]);
...
function globalDialog(DefaultComponent, supportsCustomComponent, parentApp) {
  return (pluginProps) => {
    ...
    let app = createChildApp({
      name: "QGlobalDialog",
      setup: () => () => h$1(DialogComponent, __spreadProps(__spreadValues({}, props), {
        ref: dialogRef,
        onOk,
        onHide
      }))
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function createNewTimeblock() {
      return __async(this, null, function* () {
        const { timeblockId } = yield client$1.mutation("createTimeblock", {
          date: props.date
        });
    ...
    function deleteTimeblock() {
      return __async(this, null, function* () {
        if (timeblockListing.value === void 0)
          return;
        yield client$1.mutation("deleteTimeblock", {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    (() => __async(this, null, function* () {
      const timeblockListings = yield client$1.query("listTimeblocks");
